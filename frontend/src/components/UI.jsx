...
export const Empty = ({ icon: Icon, message, title, sub }) => (
  <div style={{textAlign:"center", padding:"52px 20px", color:C.text4}}>
    ...
    <p style={{margin:0, fontSize:14, color:C.text3}}>{title || message}</p>
    {sub && <p style={{margin:'6px 0 0', fontSize:12, color:C.text4}}>{sub}</p>}
  </div>
);
