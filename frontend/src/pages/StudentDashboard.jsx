...
import {
  ...
  StickyNote, FileText, HelpCircle, Video, Radio
} from 'lucide-react';
...
import { StudentNotesTab, StudentAssignmentsTab } from './StudentNotesAndAssignments';
import StudentQuizTab   from './StudentQuizTab';
import StudentVideoView from './StudentVideoView';
...
const TABS = [
  ...
  { id:'videos',      icon:Video,        label:'Video Lectures' },
    ...
    <div style={{display:"flex",minHeight:"100vh",background:C.bg}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
        ...
        <main style={{flex:1,padding:isMobile?16:32,overflow:"auto",maxHeight:isMobile?"none":"100vh"}}>
          ...
          {tab==='notes'        && <StudentNotesTab       showNotif={showNotif}/>}
          {tab==='assignments'  && <StudentAssignmentsTab showNotif={showNotif}/>}
          {tab==='quiz'         && <StudentQuizTab        showNotif={showNotif}/>}
          {tab==='videos'       && <StudentVideoView      showNotif={showNotif}/>}
          {tab==='live'         && <StudentLiveView       showNotif={showNotif}/>}
        </main>
      </div>
    </div>
  );
